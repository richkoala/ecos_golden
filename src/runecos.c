...
int main(void)
{
    ...
    if( mywork != NULL ){
		...
		dumpDenseMatrix_UD(mywork->x        , n, 1, "./dout/result_x.txt"	);	
		dumpDenseMatrix_UD(mywork->y        , p, 1, "./dout/result_y.txt"	);	
		dumpDenseMatrix_UD(mywork->z        , m, 1, "./dout/result_z.txt"	);	
		dumpDenseMatrix_UD(mywork->s        , m, 1, "./dout/result_s.txt"	);	
		dumpDenseMatrix_UD(mywork->lambda   , m, 1, "./dout/result_lambda.txt");
		dumpDenseMatrix_UD(&(mywork->kap)   , 1, 1, "./dout/result_kap.txt");
		dumpDenseMatrix_UD(&(mywork->tau)   , 1, 1, "./dout/result_tau.txt");
